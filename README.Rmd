...
This graph proves what one would expect, that as Population increases the percent of revenue coming from Property Tax increases. The population is logarithmically transformed to adjust for the wide range in population (large number of counties with low populations and fewer with higher).
...
How is this affected by a county’s population and income? How has this changed over time?
Does population affect what a county spends its money on? 
...
What counties are the best at following their budget? How has this changed over time?
