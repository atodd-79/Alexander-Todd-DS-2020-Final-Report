...
After checking that the join worked, it seemed that the use of an apostrophe in some datasets for O'Brien county did not work with the ones that did not so it was necessary to ensure this was fixed.
